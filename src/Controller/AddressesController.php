...
class AddressesController extends AppController
{
    ...
    {
        $this->paginate = [
            'contain' => ['Provinces', 'Regions', 'Districts', 'Communes', 'Fokontanies', 'Users']
        ];
    ...
    public function add()
    {
        ...
        $regions = $this->Addresses->Regions->find('list', ['limit' => 200]);
        $districts = $this->Addresses->Districts->find('list', ['limit' => 200]);
        $communes = $this->Addresses->Communes->find('list', ['limit' => 200]);
        $fokontanies = $this->Addresses->Fokontanies->find('list', ['limit' => 200]);
        $users = $this->Addresses->Users->find('list', ['limit' => 200]);
        $this->set(compact('address', 'provinces', 'regions', 'districts', 'communes', 'fokontanies', 'users'));
        $this->set('_serialize', ['address']);
    }
